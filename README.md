...
On your first session, claude-recall automatically injects usage instructions into `~/.claude/CLAUDE.md` so Claude always knows the 3-layer search pattern. No manual setup needed.
